...
/**
 * Register an async handler that fires after every successful save().
 * Used by GistSyncProvider to push data to GitHub after local persistence.
...
/**
 * Persists data locally, notifies listeners, then delegates to the
 * registered save handler (gist sync) if one is set.
